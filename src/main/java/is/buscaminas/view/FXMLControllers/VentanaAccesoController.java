...
public class VentanaAccesoController {
    ...
    @FXML private RadioButton dificultad1;
    @FXML private RadioButton dificultad2;
    @FXML private RadioButton dificultad3;
    ...
    @FXML public void pulsarVolver(){
        Main.login(Usuario.getUsuario().getTematicaActual());
    }
}
